...
//                             {isExploreDropdownOpen && (
//                                 <div className="absolute left-0 mt-2 w-48 bg-slate-800 rounded-md shadow-lg py-1 z-50 border border-slate-700">
//                                     <a
//                                         href="YOUR_LMS_URL"
//                                         target="_blank"
//                                         rel="noopener noreferrer"
...
//                                         LMS Platform
//                                     </a>
//                                     {/* START OF CHANGE: Conditionally render "Find online tutor" link for students only. */}
//                                     {user?.role === 'student' && (
//                                         <a
//                                             href="/find-online-tutor"
//                                             className="flex items-center px-4 py-2 text-sm text-slate-300 hover:bg-slate-700 hover:text-white transition-colors"
...
//                                 <Compass className="h-5 w-5 mr-1" />
//                                 <span>Explore</span>
//                                 {isDropdownOpen ? <ChevronUp className="h-4 w-4 ml-1" /> : <ChevronDown className="h-4 w-4 ml-1" />}
//                             </button>
